...
class ResUsers(models.Model):
    ...
    def get_all_warehouse(self, user_id=None):
        ...
        for config in user.pos_config_ids:
            if config.stock_location_id.main_warehouse_id:
                warehouse_recs |= config.stock_location_id.main_warehouse_id
    ...
    def get_all_location(self, user_id=None):
        ...
        for config in user.pos_config_ids:
            ...
            warehouse = config.stock_location_id.main_warehouse_id
    ...
    def get_all_picking_type(self, user_id=None):
        ...
        for config in user.pos_config_ids:
            ...
            warehouse = config.stock_location_id.main_warehouse_id
            if warehouse:
                picking_type_recs |= warehouse.pick_type_id
                picking_type_recs |= warehouse.pack_type_id
                picking_type_recs |= warehouse.out_type_id
                picking_type_recs |= warehouse.in_type_id
                picking_type_recs |= warehouse.int_type_id
