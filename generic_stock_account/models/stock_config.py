...
class StockConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        self.action_set_property_default('product.category','property_cost_method', self.property_cost_method)
        self.action_set_property_default('product.category','property_valuation', self.property_valuation)
        # cuentas de inventario
        self.action_set_property_default('product.category','property_stock_account_input_categ_id', self.stock_account_input_id.id)
        self.action_set_property_default('product.category','property_stock_account_output_categ_id', self.stock_account_output_id.id)
        self.action_set_property_default('product.category','property_stock_valuation_account_id', self.stock_account_valuation_id.id)

    @api.multi
    def action_set_property_default(self, model, property_name, property_value):
