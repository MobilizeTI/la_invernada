...
class SiiTax(models.Model):
    ...
    def compute_all(
        ...
        if not base_values:
            ...
            total_excluded, total_included, total_retencion, base = base_values
        ...
        for tax in self.sorted(key=lambda r: r.sequence):
            ...
            if tax.amount_type == "group":
                children = tax.children_tax_ids.with_context(base_values=(total_excluded, total_included, total_retencion, base))
                ret = children.compute_all(price_unit, currency, quantity, product, partner, discount, uom_id)
                total_excluded = ret["total_excluded"]
                base = ret["base"] if tax.include_base_amount else base
                total_included = ret["total_included"]
                tax_amount_retencion = ret["total_retencion"]
            ...
            tax_base = _base
            total_retencion += tax_amount_retencion
