            ...
            for res in result:
                if res.partner_id.id:
                    ...
                    data.append({
                        ...
                        'VarietyName': res.move_ids_without_package.filtered(lambda a: 'envase' not in str.lower(a.product_id.categ_id.name) and 'bin' not in str.lower(a.product_id.display_name)).product_id.get_variety(),
                        'LotNumber': res.name,
