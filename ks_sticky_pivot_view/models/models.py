...
class KsPivotStatus(models.TransientModel):
    ...
    ks_pivot_status_header = fields.Boolean(config_parameter='base_setup.ks_pivot_status_header')
...
class KsHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        rec['ks_pivot_status_header'] = self.env['ir.config_parameter'].sudo().get_param('base_setup.ks_pivot_status_header')
        return rec
