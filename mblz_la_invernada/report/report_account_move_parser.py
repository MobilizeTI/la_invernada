...
class ReportAccountMoveParser(models.AbstractModel):
    _name = 'report.mblz_la_invernada.mblz_invernada_account_move_report'
...
#         if not data:
#             data = {}
#         docargs = self.env['report.mblz_la_invernada.mblz_invernada_account_move_report'].with_context(print_grouped=True)._get_report_values(docids, data)
