    ...
    def write(self, vals):
                ...
                if not updates.get('location_id', ml.location_id).should_bypass_reservation():
                    ...
                    try:
                        ...
                        if updates.get('lot_id'):
                            ...
                            try:
                                q = Quant._update_reserved_quantity(ml.product_id,
                                                                    updates.get('location_id', ml.location_id),
                                                                    new_product_uom_qty, lot_id=False,
                                                                    package_id=updates.get('package_id', ml.package_id),
        ...
        if updates or 'qty_done' in vals:
            ...
            for ml in mls:
                ...
                qty_done_orig = ml.move_id.product_uom._compute_quantity(ml.qty_done, ml.move_id.product_id.uom_id,
                                                                         rounding_method='HALF-UP')
                in_date = \
