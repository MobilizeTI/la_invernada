    ...
    def create(self, values_list):
        ...
        if 'unpelled_dried_id' in values_list:
            ...
            if unpelled_dried_id:
                ...
                res.out_lot_id.check_all_existence(lot_id=res.out_lot_id.id)
                res.out_lot_id.check_duplicate_quant(lot_id=res.out_lot_id.id)
                res.out_lot_id.check_no_stock_quant(lot_id=res.out_lot_id.id)
