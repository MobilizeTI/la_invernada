    ...
    def create(self, values_list):
        ...
        if 'unpelled_dried_id' in values_list:
            ...
            if unpelled_dried_id:
                ...
                res.out_lot_id.check_all_existence(product_id=res.out_lot_id.product_id.id)
                res.out_lot_id.check_duplicate_quant(product_id=res.out_lot_id.product_id.id)
                res.out_lot_id.check_no_stock_quant(product_id=res.out_lot_id.product_id.id)
