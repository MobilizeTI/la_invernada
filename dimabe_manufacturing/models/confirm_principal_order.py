    ...
    def select(self):
        ...
        for item in self.custom_dispatch_line_ids:
            item.dispatch_id.write({
                ...
                'net_weight_dispatch':self.picking_id.net_weight_dispatch,
                'gross_weight_dispatch':self.picking_id.gross_weight_dispatch,
                'tare_container_weight_dispatch':self.picking_id.tare_container_weight_dispatch,
                'container_weight':self.picking_id.container_weight,
                'arrival_weight':self.picking_id.arrival_weight,
                'departure_weight':self.picking_id.departure_weight,
                'vgm_weight_dispatch':self.picking_id.vgm_weight_dispatch,
                'sell_truck':self.picking_id.sell_truck,
                'dispatch_guide_number':self.picking_id.dispatch_guide_number,
                'transport':self.picking_id.transport,
                'gps_lock':self.picking_id.gps_lock,
                'gps_button':self.picking_id.gps_button,
                'hour_arrival':self.picking_id.hour_arrival,
                'hour_departure':self.picking_id.hour_departure,
                'dus_number':self.picking_id.dus_number,
                'sell_shipping':self.picking_id.sell_shipping,
                'canning_data':self.picking_id.canning_data,
                'type_of_dispatch':self.picking_id.type_of_dispatch,
