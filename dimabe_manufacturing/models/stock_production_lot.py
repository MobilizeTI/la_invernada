...
class StockProductionLot(models.Model):
    ...
    def add_selection_serial(self):
        ...
        if not picking.move_line_ids_without_package.filtered(lambda a: a.product_id.id == self.product_id.id):
        ...
        dispatch_line =picking.dispatch_line_ids.filtered(lambda a: a.product_id.id == self.product_id.id and self.sale_order_id.id == a.sale_id.id)
        dispatch_line.write({
