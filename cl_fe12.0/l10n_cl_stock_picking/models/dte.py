...
class stock_picking(models.Model):
    ...
    def _id_doc(self, taxInclude=False, MntExe=0):
        ...
        IdDoc['FchEmis'] = fields.Datetime.context_timestamp(self, self.scheduled_date).strftime(DF)
    ...
    def _emisor(self):
        ...
        Emisor['CorreoEmisor'] = self.company_id.dte_email_id.display_name
    ...
    def _receptor(self):
        ...
        if not partner_id.commercial_partner_id.rut():
    ...
    def _transporte(self):
        ...
        if self.transport_type in ['2', '3'] and self.chofer:
            ...
            if self.transport_type == '2':
                ...
                if not self.carrier_id.partner_id.rut():
    ...
    def _get_printed_report_name(self):
        ...
        if self.document_class_id:
            ...
            report_string = super(stock_picking, self)._get_printed_report_name()
