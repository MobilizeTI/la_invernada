...
class WebpayNormal():
	...
	def initTransaction(amount, buyOrder, sessionId, urlReturn, urlFinal):
		...
		_logger.debug("REQUEST INIT: {}".format(str(init)))
		_logger.debug("RESPONSE INIT: {}".format(str(wsInitTransactionOutput)))
	...
	def getTransaction(token):
		...
		_logger.debug("RESPONSE RESULT: {}".format(str(transactionResultOutput)))
		_logger.debug("RESPONSE ACKNOWLEDGE: {}".format(str(acknowledge)))
