...
class AccountInvoice(models.Model):
    ...
    def update_totals_kg(self):  
        ...
        raise models.ValidationError('{} {} {}'.format(sum(stock_picking_ids.mapped('gross_weight_dispatch'))  ,sum(stock_picking_ids.mapped('tare_container_weight_dispatch')),sum(stock_picking_ids.mapped('net_weight_dispatch'))))
