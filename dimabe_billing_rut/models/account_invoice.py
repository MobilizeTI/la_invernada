...
class AccountInvoice(models.Model):
    ...
    def _compute_total_commission(self):
        ...
        #                                * (sum(item.invoice_line_ids.price_unit) * sum(item.invoice_line_ids.quantity)))
    ...
    def write(self, vals):
        ...
        for s in stock_picking_ids:
            s.write({
                ...
                'shipping_company': self.shipping_company.name,
                'ship': self.ship.name,
                'ship_number': self.ship_number,
                'type_transport': self.type_transport.code,
                'departure_port': self.departure_port.code,
