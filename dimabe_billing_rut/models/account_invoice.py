                ...
                for item in product_ids: 
                    ...
                    if len(self.invoice_line_ids) > 0:
                        for line in self.invoice_line_ids:
                            raise models.ValidationError('{} = {}  - {} = {}  - {} = {}'.format(item.product_id.id, line.product_id, self.stock_picking_ids.id, line.stock_picking_id, self.order_to_add_ids.id, line.order_id))
