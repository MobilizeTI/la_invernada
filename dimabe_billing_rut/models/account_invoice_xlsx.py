    ...
    def generate_sale_book(self):
        for item in self:
            ...
            for wk in array_worksheet:
                ...
                sheet.merge_range(row +1, col +8 , row, 7, 'Totales', formats['title'])
                ...
                sheet.write(row + 2, col + 8, net_total, formats['total'])
                sheet.write(row + 2, col + 9, tax_total, formats['total'])
                sheet.write(row + 2, col + 10, total_total, formats['total'])
