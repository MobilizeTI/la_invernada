    ...
    def action_generate_csv(self):
        ...
        for payslip in payslip_recs:
            ...
            line_employee = [self._acortar_str(rut, 11),
                             ...
                             # 12
                             1 if payslip.contract_id.pension else 0,
                             ...
                             # 27
                             int(self.get_imponible_afp_2(payslip and payslip[0] or False,
                                                          self.get_payslip_lines_value_2(payslip, 'TOTIM'),
                             ...
                             int(self.get_payslip_lines_value_2(payslip, 'APV')) if self.get_payslip_lines_value_2(
                                 payslip, 'APV') else "0",
                             ...
                             int(self.get_payslip_lines_value_2(payslip, 'ISL')) if self.get_payslip_lines_value_2(
                                 payslip, 'ISL') else "0",
                             ...
                             "0" if payslip.contract_id.isapre_id.codigo == '07' else int(
                                 self.get_payslip_lines_value_2(payslip, 'SALUD')),
                             # 81 Cotizacion Adicional Voluntaria
                             "0" if payslip.contract_id.isapre_id.codigo == '07' else int(
                                 self.get_payslip_lines_value_2(payslip, 'ADISA')),
                             ...
                             int(self.get_payslip_lines_value_2(payslip, 'MUT')) if self.get_payslip_lines_value_2(
                                 payslip, 'MUT') else "0",
                             ...
                             int(self.get_payslip_lines_value_2(payslip, 'SECE')) if self.get_payslip_lines_value_2(
                                 payslip, 'SECE') else "0",
                             # 102 Aporte Empleador Seguro Cesantia
                             int(self.get_payslip_lines_value_2(payslip, 'SECEEMP')) if self.get_payslip_lines_value_2(
                                 payslip, 'SECEEMP') else "0",
