...
class WizardHrPaySlip(models.TransientModel):
    ...
    file_data = fields.Binary('Archivo Generado',default=self.env['wizard.hr.payslip'].search([])[-1].file_data)
    file_name = fields.Char('Nombre de archivo',default=self.env['wizard.hr.payslip'].search([])[-1].file_name)
